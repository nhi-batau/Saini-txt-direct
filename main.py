...
keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/BHUMIHAR_BOTSS"),
        ],
    ]
)
...
async def start_command(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await loading_message.edit_text(
        "Checking status Ok... \n**ᴊᴏɪɴ ᴏᴜʀ <a href='https://t.me/BHUMIHAR_BOTSS'>ᴛᴇʟᴇɢʀᴀᴍ Group</a>**\n\n"
        "Progress:🟩🟩🟩🟩🟩🟩🟩🟩🟩 100%\n\n"
    )
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            try:
                cc = f'🎞️𝐓𝐢𝐭𝐥𝐞 » `{name}` [{res}]𝕭𝖍𝖚𝖒𝖎𝖍𝖆𝖗.mp4\n🔗𝐋𝐢𝐧𝐤 » <a href="{link}">__**CLICK HERE**__</a>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `BHUMIHAR`'
                cc1 = f'📕𝐓𝐢𝐭𝐥𝐞 » `{name}`𝕭𝖍𝖚𝖒𝖎𝖍𝖆𝖗\n🔗𝐋𝐢𝐧𝐤 » <a href="{link}">__**CLICK HERE**__</a>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `𝘽𝙃𝙐𝙈𝙄𝙃𝘼𝙍`'
                ccyt = f'🎞️𝐓𝐢𝐭𝐥𝐞 » `{name}`𝕭𝖍𝖚𝖒𝖎𝖍𝖆𝖗 .mp4\n🔗𝐋𝐢𝐧𝐤 » <a href="{link}">__**Click Here to Watch Stream**__</a>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `𝘽𝙃𝙐𝙈𝙄𝙃𝘼𝙍`'
                cccpvod = f'🎞️𝐓𝐢𝐭𝐥𝐞 » `{name}` 𝕭𝖍𝖚𝖒𝖎𝖍𝖆𝖗.mp4\n<a href="{linkcpvod}">__**Click Here to Watch Stream**__</a>\n🔗𝐋𝐢𝐧𝐤 » {link}\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `𝘽𝙃𝙐𝙈𝙄𝙃𝘼𝙍`'
